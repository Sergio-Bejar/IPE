...
| Group Policy Briefs| 2 x 15% each = 30%|           
| Exams             | 2 x 15% each = 30% |           
...
**Group Policy Briefs:** Once the final roster of the class is available, I will randomly assign you and your classmates will be assigned to a working group (or team).  As a team, you will craft two (2) policy briefs on topics that are currently relevant in the field of International Political Economy.  Each brief should be 1,000 words long. 
...
**Quizzes:** There will be 5 quizzes.  Each of them will ask questions about a different set of readings for a specific module (see below for details). The Canvas calendar will have the  deadlines.  *Late quizzes –even a second late- will receive a zero.*

**Exams:** Students will take two(2) mid-term exams.  These exams will not be cummulative and are likely to include a combination of multiple choice, short answer and essay questions. 
